...
function personalizationClient(appId, apiKey, region, options) {
  ...
  if (!region || region && (typeof region !== "string" || !REGIONS4.includes(region))) {
    throw new Error(`\`region\` is required and must be one of the following: ${REGIONS4.join(", ")}`);
  }
...
var apiClientVersion6 = "5.23.2";
function getDefaultHosts6(appId) {
  return [
    {
...
function createSearchClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts6(appIdOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Search",
...
var apiClientVersion7 = "1.23.2";
var REGIONS6 = ["eu", "us"];
function getDefaultHosts7(region) {
...
function createIngestionClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts7(regionOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Ingestion",
...
var apiClientVersion8 = "1.23.2";
function getDefaultHosts8() {
...
var apiClientVersion9 = "5.23.2";
function getDefaultHosts9(appId) {
  return [
    {
      url: `${appId}-dsn.algolia.net`,
      accept: "read",
...
function createRecommendClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts9(appIdOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Recommend",
...
__reExport(browser_exports10, models_exports);
...
export {
  algoliasearch,
  apiClientVersion6 as apiClientVersion
};
